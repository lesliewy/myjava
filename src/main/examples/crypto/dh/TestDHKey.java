...
public class TestDHKey { 
   ...
   private void run() throws Exception {
	//       Security.addProvider(new com.sun.crypto.provider.SunJCE()); 
	   ...
	   PublicKey alicePubKey = bobKeyFac.generatePublic(x509KeySpec);  // 产生alice的公钥，以便从中获取参数.
	   System.out.println("alice 公钥 bob 解码成功"); 
	   // bob 必须用相同的参数初始化的他的 DH KEY 对 , 所以要从 Alice 发给他的公开密钥 中读出参数 , 再用这个参数初始化他的 DH key 对
