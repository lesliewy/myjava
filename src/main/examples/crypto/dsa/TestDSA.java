...
public class TestDSA { 
	 ...
	 public void run(){
		...
		// 第二步 , 此用户从文件中读入私钥 , 对一个字符串进行签名后保存在一个文件 (myinfo.dat) 中
		...
		// 为了方便数字签名也放进了 myifno.dat 文件中 , 当然也可分别发送
		  try { 
			...
			//   java.security.spec.X509EncodedKeySpec 
			 ...
			 System.out.println("signed( 签名内容 )="+MyConvertUtils.byte2hex(signed)); 
			// 把信息和数字签名保存在一个文件中
		 ...
		 try {
			  ...
			  in.close(); 
			  System.out.println(pubkey.getFormat());   // 获取编码方式.
